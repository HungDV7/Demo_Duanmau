...
import service.impl.HDChiTiet_Service;
import service.impl.HoaDon_Service;
...
public class HoaDon_View extends javax.swing.JFrame {
    ...
    HoaDon_Service HD_SV = new HoaDon_Service();
    HDChiTiet_Service DHCT_SV = new HDChiTiet_Service();
//    ArrayList<ChiTietSP_Model> listSP = new ArrayList<>();
    ArrayList<HDChiTiet_Model> listGH = new ArrayList<>();
    ArrayList<GioHang_QLHoaDon> listGHView = new ArrayList<>();
    ArrayList<CTSP_View> listSPCT = new ArrayList<>();
    ...
    private void tblSanPhamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPhamMouseClicked
        ...
        try {
            ...
            ChiTietSP_Model SP = CTSP_Service.getCTSPByid(listSPCT.get(index).getId());
            if (SP.getSlTon() <= 0) {
...
//        }
        ...
        HoaDon_Model h = getHoaDon();
        HD_SV.add(h);
        fillHD();
        tblSanPham.setEnabled(true);
        tblGioHang.setEnabled(true);
        btnThanhToan.setEnabled(true);
        HoaDon_Model hD = HD_SV.getHDByMa(listViewHoaDon.get(0).getMa().toString());
        showHD(hD);
    ...
    private void tblGioHangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblGioHangMouseClicked
        ...
        try {
            ...
            HDChiTiet_Model h = listGH.get(index);
            ChiTietSP_Model sp = h.getChiTietSP();
            UpdateSL(sp, -1);
            if (h.getSL() == 1) {
                DHCT_SV.delete(h);
            } else {
...
//            txtTienKhach.setText(numberFM.format(khach));
    ...
    private void tblHoaDonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblHoaDonMouseClicked
        ...
        HoaDon_Model h = HD_SV.getHDByMa(tblHoaDon.getValueAt(index, 1).toString());
        showHD(h);
        listGH = (ArrayList<HDChiTiet_Model>) DHCT_SV.getHDCTByMaHD(txtMaHD.getText().toString());
...
//        }
    ...
    public void filltblSP() {
        listSPCT = (ArrayList<CTSP_View>) CTSP_Service.getAllSPView();
        mol = (DefaultTableModel) tblSanPham.getModel();
        mol.setRowCount(0);
        for (CTSP_View c : listSPCT) {
    ...
    public void UpdateSL(ChiTietSP_Model SP, int SL) {
    ...
    public void filltblGH() {
        listGH = (ArrayList<HDChiTiet_Model>) DHCT_SV.getHDCTByMaHD(txtMaHD.getText());
    ...
    public void showHD(HoaDon_Model h) {
    ...
    public HoaDon_Model getHoaDon() {
        ...
        String ma = "HD" + count;
        return new HoaDon_Model(ma, getDate(), 1);
    }
    ...
    public void addGH(int index) {
        ...
        if (chk == true) {
            HDChiTiet_Model h = new HDChiTiet_Model(HD_SV.getHDByMa(txtMaHD.getText()), CTSP_Service.getCTSPByid(id), 1, listSPCT.get(index).getGiaBan());
//            listGH.add(h);
            DHCT_SV.addSP(h);
        }
        //add row tblGioHang
...
//            DHCT_SV.addSP(h);
//        }
        HoaDon_Model h = HD_SV.getHDByMa(txtMaHD.getText());
        HD_SV.ThanhToan(h);
    }

    public void search(String keyWord) {
        listSPCT = (ArrayList<CTSP_View>) CTSP_Service.search(keyWord);
        mol = (DefaultTableModel) tblSanPham.getModel();
        mol.setRowCount(0);
        int i = 1;
        for (CTSP_View c : listSPCT) {
